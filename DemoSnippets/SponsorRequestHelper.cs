...
namespace DemoSnippets
{
    public class SponsorRequestHelper
    {
        ...
        private static async Task ShowPromptForSponsorshipAsync()
		{
			...
			await OutputPane.Instance.WriteAsync("leave a positive review at https://marketplace.visualstudio.com/items?itemName=MattLaceyLtd.DemoSnippets&ssr=false#review-details");
			await OutputPane.Instance.WriteAsync("");
			await OutputPane.Instance.WriteAsync("********************************************************************************************************");
		}
    }
